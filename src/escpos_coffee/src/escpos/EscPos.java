...
public class EscPos implements Closeable, Flushable , EscPosConst{
    ...
    */
     ...
     * Can be used to send customizes commands to printer. 
     *
     * @param      b     the data.
    ...
    /**
     * Set style of actual instance. <p>
    ...
    /**
     * Select character code table. <p>
     * each table represent specifics codes for special characters, example 
     * when we need to print accents characters.
     * This function combine setCharsetName to be used on  <code>String.getBytes</code>
     * and setPrinterCharacterTable to be used on printer. Then next time that 
     ...
     * Is recommended that you use <code>setCharacterCodeTable</code>, 
     * but if you need to use one specific code that is not included in <code>CharacterCodeTable</code>
     * or if the <code>CharacterCodeTable</code> codes diverges of your printer documentation, 
     * then you should use this function.<p>
     * ASCII ESC t n
     * 
    ...
    /**
     * Write String to outputStream. <p>
    ...
    /**
     * Prints the data in the print buffer and feeds n lines. <p>
     * ASCII ESC d 
     ...
     * @param nLines number of lines with the line spacing of <code>defaultStyle</code>
     * @return this object.
     * @exception  IOException  if an I/O error occurs.
     * @exception  IllegalArgumentException if nLines out of range 0 to 255
    ...
    /**
     * Initialize printer.
     * Clears the data in the print buffer and resets the printer.<p>
     * reset style of this object.
     * ASCII ESC @<p>
     * @return this object
     * @see #setStyle(escpos.Style) 
     * 
     ...
     * The pulse for ON time is(t1× 2 msec) and for OFF time is(t2× 2 msec).<p>
     * 
